...
const wyvern_exchange_v1_1 = require("./abi_gen/wyvern_exchange_v1");
...
class WyvernProtocol {
    constructor(provider, config) {
        ...
        this.wyvernExchangeV1 = new wyvern_exchange_v1_1.WyvernExchangeV1Contract(exchangeV1ContractAddress, provider);
    ...
    static getExchangeV1ContractAddress(network) {
        return constants_1.constants.DEPLOYED[network].WyvernExchangeV1;
    }
    ...
    static isValidOrderHash(orderHash) {
        ...
        const isValidOrderHash = schemaValidator.validate(orderHash, schemas_1.schemas.orderHashSchema).valid;
    ...
    static encodeOrderData(data) {
        switch (data.dataType) {
            case "ORDER_DATA_TYPE_V1": {
                const V1 = "0x4c234266"; //bytes4(keccak256("V1"));
                const encoded = abiCoder.encodeParameter(constants_1.ORDER_DATA_V1_TYPE, {
    ...
    static decodeOrderData(dataType, data) {
        switch (dataType) {
            case "ORDER_DATA_TYPE_V1": {
                const decodedData = abiCoder.decodeParameter(constants_1.ORDER_DATA_V1_TYPE, data.slice(2));
                return decodedData;
            }
            default: {
    ...
    signOrderHashAsync(orderHash, signerAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const signature = yield this._web3Wrapper.signTransactionAsync(signerAddress, msgHashHex);
