...
var WyvernProtocol = /** @class */ (function () {
    ...
    WyvernProtocol.generatePseudoRandomSalt = function () {
        ...
        var salt = randomNumber.times(factor).dp(0, 1);
        return salt;
    };
    /**
    ...
    WyvernProtocol.encodeOrderData = function (data) {
        switch (data.dataType) {
            case "ORDER_DATA_TYPE_V1": {
                var V1 = "0x4c234266"; //bytes4(keccak256("V1"));
                var encoded = abiCoder.encodeParameter(constants_1.ORDER_DATA_V1_TYPE, {
