...
exports.utils = {
    ...
    getOrderHashHex(order) {
        ...
        const arrWyvernExchangeV1 = [
            constants_1.constants.DEPLOYED.rinkeby.WyvernExchangeV1.toLowerCase(),
            constants_1.constants.DEPLOYED.mumbai.WyvernExchangeV1.toLowerCase(),
            constants_1.constants.DEPLOYED.main.WyvernExchangeV1.toLowerCase(),
            constants_1.constants.DEPLOYED.matic.WyvernExchangeV1.toLowerCase(),
        ];
